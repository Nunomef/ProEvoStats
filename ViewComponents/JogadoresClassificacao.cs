...
{
    public class JogadoresClassificacao : ViewComponent
    {
        private readonly ApplicationDbContext _context;

        public JogadoresClassificacao(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View(estatisticasJogadores);
        }
        ...
        //{
        //    var campeonatosVencidos = _context.Campeonatos
        //         .Where(c => c.Status == Status.Inactive && GetCampeonatoVencedorId(c.Id) == jogadorId)
        //         .Count();
