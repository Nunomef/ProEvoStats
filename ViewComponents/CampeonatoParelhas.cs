...
{
    public class CampeonatoParelhas : ViewComponent
    {
        private readonly ApplicationDbContext _context;

        public CampeonatoParelhas(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(int campeonatoId)
        {
            ...
            var resultadosViewModel = resultados.Select(r => new CampeonatoParelhasViewModel
            {
